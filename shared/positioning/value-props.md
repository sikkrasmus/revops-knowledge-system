...
> Phase 0 abstract example. Replace the specific outcomes and proof points with real ones when forking.

## Primary value prop (across all segments)

> `<one sentence, unhedged, outcome-framed, grammatically complete>`

Proof points:

- `<proof point 1 [source: ...]>`
- `<proof point 2 [source: ...]>`
- `<proof point 3 [source: ...]>`

## Segment-specific framing

### SMB / self-serve  {motion: plg, segment: smb}

Framing is product-first: "here's what it does, try it, upgrade when you need more." The value prop is the product itself, not an outcome narrative.
