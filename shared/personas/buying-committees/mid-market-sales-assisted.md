...
Applies to mid-market deals in the sales-assisted motion. Typical shape: $15 to $80K ACV, 1 to 3 month sales cycle, 1 to 2 year term. Above SMB or PLG (an AE is involved). Below enterprise (procurement, legal, and security do not gate the deal).
...
| Approver (typically VP-level: VP Sales, VP Operations, COO) | Sign-off on budget | "Show me the ROI case" | — |
| Reviewer (typically an IC or senior IC who uses the tool daily) | Technical fit, integration check | "Will this integrate with X?" | — |

Total committee size: 2 to 4 people. Finance is occasionally looped in for budget approval above a threshold; security is rarely involved.
...
3. **Business case.** Champion plus Reviewer build the ROI story for the Approver.
4. **Approval.** Approver asks for reference calls, pricing negotiation, and signs the contract.
5. **Kickoff.** CS onboarding typically 2 to 4 weeks.

Total cycle: 4 to 12 weeks. Longer when the Approver is net-new to the role or the company has had a recent tooling consolidation.
...
- **Lost when.** Champion departs (new-hire risk flag), Approver changes, or a competitor lands at a materially lower price with similar integration depth.

## Segment-specific variants

### Lower mid-market (under $25K ACV)  {segment: mid-market}

Committee compresses to 2 people (Champion plus Approver). Cycle shortens to 2 to 6 weeks. Less negotiation leverage on pricing.
