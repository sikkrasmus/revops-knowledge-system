...
VP Sales (sometimes VP of Sales, Senior Sales Director, or Head of Sales) owns the revenue-producing motion. Reports to CRO, CEO, or COO depending on company shape. Typically manages 1 to 3 layers of people (team leads or managers above ICs), ranging from 5 to 60+ reps. Carries the aggregate quota. Fired or promoted on the delta.
...
- **Owns**: sales methodology adoption, playbook enforcement, rep ramp programs, compensation plan design (often jointly with Finance and RevOps), territory and named-account design (jointly with RevOps), deal-desk escalation approval for the discount band above the rep tier.
- **Reports to**: CRO, CEO, or COO. In $10 to $30M ARR companies this is often the top revenue role.
- **Direct reports**: 3 to 12 typically (sales managers, enablement leads, sometimes solutions engineering).
- **Budget authority**: headcount and tooling co-approval; deal-discount authority at the strategic-exception band per [`../../pricing/discount-guardrails.md`](../../pricing/discount-guardrails.md).
...
- **Forecast credibility.** Weekly roll-up that the CRO can defend to the CEO and Board. Forecast misses compound: one miss costs credibility, two consecutive misses cost the role.
- **Deal slip at late stage.** Deals that pass evaluation and then stall in procurement or legal. The VP cannot personally unstick every deal, so patterns matter.
- **Ramp time for new reps.** Hiring is the response to coverage gaps; every month of slow ramp delays the response.

## What they care about

- Rep attainment distribution. Not just the average but the shape (too top-heavy signals a hiring or territory problem; too bottom-heavy signals a management problem)
...
- Average deal size trend, plus what is driving any movement
...
- Positioning pitches that do not translate to a rep's one-call pitch
- Competitive intelligence that is not actionable at deal level
...
- **Buying motion preference**: wants a pilot with their real reps on real deals; does not make decisions on demos alone. 30 to 60 day pilot is typical.
...
- VP Sales at $10 to $30M ARR often doubles as the deal desk and as the primary pipeline-review manager; authority is concentrated.
- Purchase decisions for sales tooling are usually VP Sales plus CRO (if separate) plus RevOps lead; procurement is light.
- Pilot expectations: 30-day real-deal pilot with 2 to 4 reps is typical before a rollout.
...
- Pilot expectations: formal POC with success criteria, executive readout, 60 to 90 day evaluation before global rollout.

## Career motivations

- **Delivering the number** is the first-order motivator. Quota attainment is visible and compounds trust.
- **Promotion path.** VP Sales at $10 to $30M often promotes into CRO or Head of GTM at scale; success here is strongly tied to being seen as the operator who made the org scalable.
- **Reputation in the category.** External visibility at conferences, podcasts, and LinkedIn content in the sales-leadership community matters to many VPs.
